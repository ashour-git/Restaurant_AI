...
This module configures the Alembic environment to use async SQLAlchemy
and loads models for autogenerate support.
"""
...
def run_migrations_online() -> None:
    ...
    Creates an Engine and connects to run migrations.
    """
